...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.carousel = function () {
  for (let i = 0; i < this.length; i++) {
    ...
    (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i].querySelector('[data-slide="next"]')).click(e => {
      ...
      slidesField.style.transform = `translateX(-${offset}px)`; // -(минус) это значит перемещаем блок влево
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.modal = function (created) {
  for (let i = 0; i < this.length; i++) {
    ...
    (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).click(e => {
      ...
      document.body.style.overflow = 'hidden'; // по стандарту, чтобы под модальным окном не пролистывалась страница
    });
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.eq = function (i) {
  // i - номер того элемента из выборки, который нам понадобится. первый..второй..третий..или ещё какой.
  const swap = this[i];
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.find = function (selector) {
  ...
  for (let i = 0; i < copyObj.length; i++) {
    ...
    if (arr.length == 0) {
      // если не найдено ни одного, то прекращаем эту итерацию.
      continue;
    }
...
(0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').click(() => (0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').createModal({
  ...
  btns: {
    count: 2,
    settings: [['Close', ['btn-danger', 'mr-10'], true], ['Btn changes', ['btn-success'], false, () => {
